...
<path d="M10.5005 6.38862V4.36762C10.4627 2.4718 8.89635 0.964926 7.00049 1.00062C5.10462 0.964926 3.53823 2.4718 3.50049 4.36762V6.38762" stroke="#DCDCDC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="white" stroke="url(#paint0_linear_2988_1275)"/>
<defs>
...
export const getShopIcon = ({isGradient = false}) => {
  return isGradient ? ShopIconWithGradient : ShopIcon;
};
